...
const Home: NextPage = () => {
  ...
  return (
    <div className='bg-[#EEEDFB] bg-[url("../public/clouds.svg")]/10 h-screen text-slate-700 snap-y snap-mandatory overflow-y-scroll overflow-x-hidden z-0 scrollbar scrollbar-track-gray-500/30 scrollbar-thumb-[#F7AB0A]'>
      <Head>
