...
const Home: NextPage = () => {
  ...
  return (
    //9FB4F9
    <div className='bg-[#FACBB2] bg-[url("../public/clouds.svg")] h-screen text-slate-700 snap-y snap-mandatory overflow-y-scroll overflow-x-hidden z-0 scrollbar scrollbar-track-gray-500/30 scrollbar-thumb-[#F7AB0A]'>
      <Head>
