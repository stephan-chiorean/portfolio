      ...
      <div className="group relative flex cursor-pointer">
        {!shouldRenderPercent ?
          ...
          <motion.img
            ...
            src={skillPhotos[skill].src}
            alt=""
            className="rounded-full border-5 border-technology bg-white/80 object-contain p-1 h-24 w-24 md:w-28 md:h-28 xl:w-32 xl:h-32 filter group-hover:grayscale ease-in-out"
          />
        }
