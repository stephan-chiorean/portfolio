...
function Experience({}: Props) {
  ...
  return (
    <motion.div
      ...
      className='h-screen flex relative overflow-hidden flex-col text-lft md:flex-row max-w-full px-4 md:px-10 justify-evenly mx-auto items-center'
    >
      ...
      {renderMobile ? (
        <div
          className='w-full flex space-x-10 overflow-x-scroll mt-5 mb-0 scrollbar scrollbar-track-gray-500/30 scrollbar-thumb-[#F7AB0A]'
