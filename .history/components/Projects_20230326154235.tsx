        ...
        {projects.map((project, i) => (
          <div className='w-full flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-5 md:p-10'>
            <div className="flex flex-col md:flex-row space-x-3 justify-center">
              {i<6 && <button className="px-3 py-2 bg-technology text-technology-xdark text-xl rounded-md">See Demo</button>}
              <button className="px-3 py-2 bg-technology text-technology-xdark text-xl rounded-md">Github</button>
            </div>
            <a href={links[i]}>
              <img
                src={projectos[i].src}
