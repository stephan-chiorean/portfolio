      ...
      <div className='relative w-screen flex overflow-x-scroll snap-x snap-mandatory z-20 scrollbar scrollbar-w-8 scrollbar-track-gray-500/30 scrollbar-thumb-[#F7AB0A]'>
        {projects.map((project, i) => (
          <div className='w-full flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-5 md:p-10'>
            <div className="flex space-x-3 justify-center md:hidden">
              <button className="px-3 py-2 bg-technology text-technology-xdark rounded-md">See Demo</button>
              <button className="px-3 py-2 bg-technology text-technology-xdark rounded-md">Github</button>
            </div>
            <a href={links[i]}>
              <img
                src={projectos[i].src}
