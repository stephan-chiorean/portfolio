...
const projectos = [vaas, market, messenger, verified, pitchit, fleetman, travel];
    ...
    >
      ...
      <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar scrollbar-w-8 scrollbar-track-gray-500/30 scrollbar-thumb-[#F7AB0A]'>
        {projects.map((project, i) => (
          <div className='w-screen border-3 border-red-500 flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-15 md:p-20 h-screen'>
            <a href={links[i]}>
              <img
                src={projectos[i].src}
                alt=''
                className='max-h-[75%] mt-50 object-contain cursor-pointer'
              />
            </a>
