...
function Contact({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailto:stephan.chiorean@gmail.com?subject=${
      formData.subject
  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col space-y-10'>
        {shouldRenderConnect && (
          <h4 className='font-semibold text-4xl text-center'>Let's Connect!</h4>
        )}
        <div className='space-y-3 md:space-y-10'>
          <div className='flex items-center space-x-5 justify-center'>
            <PhoneIcon className='text-[#F7AB0A] h-7 w-7 animate-pulse' />
            <p className='text-[15px] md:text-2xl'>425-628-9449</p>
          </div>
          <div className='flex items-center space-x-5 justify-center'>
            <MapPinIcon className='text-[#F7AB0A] h-7 w-7 animate-pulse' />
            <p className='text-[15px] md:text-2xl'>Seattle, Washington</p>
          </div>
          <div className='flex items-center space-x-5 justify-center'>
            <EnvelopeIcon className='text-[#F7AB0A] h-7 w-7 animate-pulse' />
            <p className='text-[15px] md:text-2xl'>stephan.chiorean@gmail.com</p>
          </div>
        </div>
        <form
