...
function Projects({}: Props) {
  ...
  return (
    ...
    >
      ...
      <div className='relative w-full flex overflow-x-scroll h-full snap-x snap-mandatory z-20 scrollbar scrollbar-w-8 scrollbar-track-gray-500/30 scrollbar-thumb-[#F7AB0A]'>
