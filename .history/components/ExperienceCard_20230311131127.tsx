...
function ExperienceCard({ experience }: Props) {
  ...
  return (
    <article
      className='flex flex-col rounded-lg items-center space-y-3 md:space-y-7 flex-shrink-0 w-[400px] md:w-[500px] xl:w-[600px] snap-center bg-white p-3 md:p-10 border-2 border-gray-500 hover:border-[#F7AB0A] transform transition duration-300 ease-in-out hover:scale-110 opacity-100 cursor-pointer max-h-[600px] md:max-h-[670px] overflow-y-hidden hover:overflow-y-scroll' style={{zIndex:'30', position:'relative'}}>
      <motion.img
        initial={{
          y: -100,
          opacity: 0,
      ...
      <div className='px-0 md:px-5'>
        ...
        <ul className='list-disc space-y-1 text-[10px] md:text-lg'>
