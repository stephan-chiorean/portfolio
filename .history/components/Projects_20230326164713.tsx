        ...
        {projects.map((project, i) => (
          <div className='w-full flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-5 md:p-10'>
            <div id="track" className="flex items-center flex-col md:flex-row space-x-3 space-y-5 md:space-y-0 mb-6 md:mb-0 border-2 border-red-500">
              ...
              <Link href={links[i]} className="mr:5 md:mx-0 px-3 py-2 bg-technology text-center text-technology-xdark text-xl rounded-md hover:bg-technology-secondary">Github</Link>
            </div>
            <a href={links[i]}>
              <img
                src={projectos[i].src}
