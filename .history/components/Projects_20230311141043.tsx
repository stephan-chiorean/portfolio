          ...
          <div className='w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen'>
            <a href={links[i]}>
              <img
                src={projectos[i].src}
                alt=''
                className='md:h-80 md:w-160 object-cover cursor-pointer'
              />
            </a>
            <div className='space-y-10 px-10 md:px-10 max-w-6xl'>
              ...
              <div className='flex justify-evenly space-x-2 md:space-x-5 my-2 border-[#F7AB0A] p-5 bg-[#f7ebd3fe] z-30 rounded-md'>
