...
function Skills({}: Props) {
  return (
    ...
    >
      ...
      <div
        className='grid grid-cols-3 gap-1 max-h-[400px] mt-20 md:max-h-none overflow-y-scroll md:grid-cols-8 md:gap-5 scrollbar scrollbar-w-1 scrollbar-track-gray-500/30 scrollbar-thumb-[#F7AB0A]'
      >
