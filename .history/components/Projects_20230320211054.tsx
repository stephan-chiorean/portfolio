    ...
    >
      ...
      <div className='relative w-full flex overflow-x-scroll snap-x snap-mandatory z-20 scrollbar scrollbar-w-8 scrollbar-track-gray-500/30 scrollbar-thumb-[#F7AB0A]'>
        {projects.map((project, i) => (
          <div id="track" className='w-screen flex-shrink-0 border-15 border-red-500 snap-center flex flex-col space-y-5 items-center justify-center p-5 md:p-10 h-screen'>
            <a href={links[i]}>
              <img
                src={projectos[i].src}
                alt=''
