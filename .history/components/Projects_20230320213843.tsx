...
function Projects({}: Props) {
  ...
  return (
    ...
    >
      <h3 className='absolute top-5 uppercase tracking-[20px] text-[#D6DEF8] font-bold text-2xl'>
        Projects
      </h3>
      <motion.div 
      initial={{opacity: 1}}
      ...
      className="absolute top-[70px] uppercase tracking-[5px] md:tracking-[10px] font-semibold text-[#D6DEF8] text-xl">
        Scroll for more &#10132;
      </motion.div>
