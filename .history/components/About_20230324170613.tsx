  ...
  return (
    <div className='flex flex-col text-center md:text-left md:flex-row relative h-screen max-w-7xl px-10 justify-evenly mx-auto items-center'>
      ...
      <motion.div
        ...
        transition={shouldAnimate ? { duration: 1.4 } : {}}
        className='space-y-10 px-5 md:px-10 py-5 md:py-10 md:mx-5 bg-white/80'
      >
        {shouldRenderP && (
        ...
        <div className="flex space-x-5 md:space-x-10">
          <a href={'/portfolioResume.pdf'} download>
            <button className='bg-technology text-technology-xdark md:text-xl py-2 px-4 rounded-md mt-4 hover:scale-110 transition duration-100 ease-in-out'>
              Download Resume
            </button>
          </a>
          <Link 
          className="bg-technology text-technology-xdark py-2 px-4 md:text-xl rounded-md mt-4 hover:scale-110 transition duration-100 ease-in-out"
